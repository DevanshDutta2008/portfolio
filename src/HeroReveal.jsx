  ...
  return (
    <section className="reveal-section" aria-label="Featured portrait">
      <button
        ...
        aria-pressed={forced}
        aria-label={forced ? 'Vision-scan revealed — press to hide' : 'Move the pointer to reveal the vision-scan, or press to reveal it fully'}
