...
import baseImg from './assets/devansh-base.jpg';
  ...
  return (
    <section ref={sectionRef} className="dive-section" id="work">
      <div className="dive-sticky">
        <img className="dive-cover-bg" src={baseImg} alt="" draggable="false" />

        <div className="dive-masked">
          <div className="dive-video" aria-hidden="true" />
        ...
        <div className="dive-journey-content">
          <h2 className="dive-journey-title">
            <span className="dive-journey-title-span">through</span>  THIS<br />SPACE WITH ME
          </h2>
        </div>
      </div>
    </section>
