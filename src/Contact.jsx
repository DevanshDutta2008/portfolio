...
const EMAIL = 'devanshdtt@gmail.com';

const WORDS = ['systems', 'products', 'maps', 'intelligence'];
...
const SOCIALS = [
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/devansh-dutta-755007365/' },
  { label: 'GitHub', href: 'https://github.com/DevanshDutta2008' },
];
