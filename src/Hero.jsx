...
const ROTATING_WORDS = ['SYSTEMS', 'VISION', 'PRODUCTS', 'INTELLIGENCE', 'SPACE'];
    ...
    <>
      <header className="site-nav">
        ...
        <a href="#top" className="nav-logo">
          <span className="logo-from">Devansh</span>
          <span className="logo-another">Dutta</span>
        </a>
      ...
      <section className="hero" id="top" ref={heroSectionRef}>
        <h1 className="hero-headline">
          NOT JUST<br />
          CODE &mdash; <span className="curve-anchor">I</span><br />
          BUILD
          <br />
      ...
      >
        ...
        <div className="menu-contact" style={{ '--menu-i': MENU_LINKS.length }}>
          ...
          <a
            href="mailto:devanshdtt@gmail.com"
            className="menu-contact-email"
            tabIndex={menuOpen ? 0 : -1}
          >
            devanshdtt@gmail.com
          </a>
        </div>
      </div>
    </>
